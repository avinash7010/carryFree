...
function Register() {
    return (
        <div id="ReportLost" className="d-flex flex-column w-90 mx-4 mx-md-2 mb-2 px-4 py-2 rounded border border-primary align-items-center justify-content-center">
            <div className="d-flex flex-column w-50 w-lg-100 px-5 py-5 mt-4 rounded align-items-center justify-content-center gap-3 bg-primary-subtle">
                <h2 className="h2 display-6 fw-bold text-center my-1 gap-1">🎓 Register On CarryFree</h2>
                <form className="login-form d-flex flex-column w-100 gap-3 my-2">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg px-5 py-2 align-self-center mt-4">
                        Create CarryFree Community
                    </button>
                </form>

                <div className="login-footer d-flex text-center gap-2">
                    <p>Already have an account? <Link to="/login" className="text-primary text-decoration-underline">Login</Link></p>
                </div>
            </div>
        </div>
    )
